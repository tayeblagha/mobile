...
const routes: Routes = [
  ...
  {
    path: 'event-details',
    loadChildren: () => import('./pages/school/event-details/event-details.module').then( m => m.EventDetailsPageModule)
  },
  {
    path: 'login',
  ...
  {
    path: 'studentui',
    loadChildren: () => import('./studentui/studentui.module').then( m => m.StudentuiPageModule)
  },
  {
    path: 'update-etudiant',
    loadChildren: () => import('./update-etudiant/update-etudiant.module').then( m => m.UpdateEtudiantPageModule)
  },
];
